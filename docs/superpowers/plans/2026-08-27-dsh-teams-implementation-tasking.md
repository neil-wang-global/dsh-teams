...
| DT-0-02 | complete | DT-0-01 | Surface inventory and composed-runtime registration research are recorded. |
| DT-0-03 | complete | DT-0-02 | Fail-closed interception result and deny-probe evidence are recorded. |
...
- [x] Capture every route, upgrade, and generic RPC registration from a disposable composed runtime; update the report and fixture from that trace.
...
- [x] Capture and deny-probe the complete composed runtime registration inventory before choosing an adapter architecture.
